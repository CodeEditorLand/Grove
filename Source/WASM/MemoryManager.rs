//! WASM Memory Manager
//!
//! Manages memory allocation, deallocation, and limits for WebAssembly instances.
//! Enforces memory constraints and provides tracking for debugging.
...
impl MemoryLimits {
    ...
    pub fn initial_memory_bytes(&self) -> u64 {
        self.initial_memory_mb * 1024 * 1024
    }
...
impl MemoryManager {
    ...
    pub fn deallocate_memory(&mut self, instance_id: &str, memory_id: &str) -> Result<bool> {
        debug!(
            "Deallocating memory {} for instance {}",
    ...
    pub fn grow_memory(
        ...
        debug!(
            "Memory grown successfully. New size: {} bytes",
    ...
    pub fn is_exceeded(&self) -> bool {
        self.current_usage_bytes() > self.limits.max_memory_bytes()
    }
