...
//! This implements the interface described in vscode.d.ts for extension compatibility.
...
impl Languages {
    ...
    pub fn create_diagnostic_collection(
        &self,
        name: Option<String>,
...
impl Extensions {
    ...
    pub fn get_extension(&self, extension_id: String) -> Option<Extension> {
        None
    }
}
...
impl Env {
    ...
    pub fn get_env_var(&self, name: String) -> Option<String> {
        std::env::var(name).ok()
    }
    ...
    /// Get the app root
    pub fn app_root(&self) -> Option<String> {
        std::env::var("VSCODE_APP_ROOT").ok()
    }
}
