...
use crate::Host::{Activation, ExtensionManager, HostConfig};
...
impl ExtensionHost {
    ...
    pub async fn new(transport: Transport) -> Result<Self> {
        Self::with_config(transport, HostConfig::default()).await
    }
    ...
    pub fn activation_engine(&self) -> &Arc<Activation::ActivationEngine> {
        &self.activation_engine
    }
